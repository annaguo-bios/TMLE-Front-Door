...
for estimand in "ATT"; do
    for M in "continuousM"; do
        for estimator in "TMLE-est1" "Onestep-est1" "TMLE-est1-dnorm" "Onestep-est1-dnorm" "TMLE-est2-dnorm" "Onestep-est2-dnorm" "TMLE-est2a" "Onestep-est2a" "TMLE-est2b" "Onestep-est2b"; do
