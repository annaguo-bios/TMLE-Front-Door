...
load("binaryM/Linear/Onestep-est1/ATT_result.Rdata")
...
# Binary M, Onestep, SL -----------------
load("binaryM/SL/Onestep-est1/ATT_result.Rdata")
...
load("binaryM/Linear/TMLE-est1/ATT_result.Rdata")
...
load("binaryM/SL/TMLE-est1/ATT_result.Rdata")
...
load("continuousM/Linear/Onestep-est2a/ATT_result.Rdata")
...
load("continuousM/Linear/Onestep-est2b/ATT_result.Rdata")
...
load("continuousM/SL/Onestep-est2a/ATT_result.Rdata")
...
load("continuousM/SL/Onestep-est2b/ATT_result.Rdata")
...
load("continuousM/Linear/TMLE-est2a/ATT_result.Rdata")
...
load("continuousM/SL/TMLE-est2a/ATT_result.Rdata")
...
load("continuousM/Linear/TMLE-est2b/ATT_result.Rdata")
...
load("continuousM/SL/TMLE-est2b/ATT_result.Rdata")
...
table1 <- as_hux(dat) %>% 
  ...
  set_font_size(7) %>% set_escape_contents(nrow(.), 1:ncol(.), FALSE) %>% set_caption("Performance of ATT estimators under model misspecifications across mediator types.") 
