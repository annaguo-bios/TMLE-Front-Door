...
table1 <- as_hux(dat.table[,-1]) %>% 
  insert_row("All binary","","","","Y continuous","","","","Y,X continuous","","","","All continuous","","","", after = 0) %>% 
  insert_row("Type I error","","Power","","Type I error","","Power","","Type I error","","Power","","Type I error","","Power","", after = 1) %>% 
  insert_row("ADMG1","ADMG2","ADMG3","ADMG4","ADMG1","ADMG2","ADMG3","ADMG4","ADMG1","ADMG2","ADMG3","ADMG4","ADMG1","ADMG2","ADMG3","ADMG4",after=2) %>%
  insert_row("CATE-based test","","","","","","","","","","","","","","","",after=3) %>%
  ...
  set_font_size(6) %>% set_caption("Test results.")
