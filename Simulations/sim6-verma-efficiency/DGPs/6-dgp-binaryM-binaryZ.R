...
# dt <- generate_data(1000)$data; parA = c(0.3,0.2); parU=c(1,1,-0.2,0); parM = c(-1,1,1,0); parY = c(1, 1, 1, 0); sd.U=1; sd.Y=1
#



# 
# generate_data <- function(n,parZ=0.5, parA = c(0.3,0.2), parU=c(1,1,-0.2,0), parM = c(-1,1,1,0), parY = c(1, 1, 1, 0), sd.U=0.2, sd.Y=0.2){ # change the parM to c(-1,1,1,0)
#   
...
# 
# 
# dat_output = generate_data(10000)
