EYa.binaryZ.binaryM <- function(a,data,treatment, mediator, outcome, anchor,
  ...
  f.tmle.binaryZM <- function(a,z=NULL){ # 1. if z=null, then return estimand from the regular ID functional where z is not fixed, 2. if z is not null, then return the estimand from the ID functional where z is fixed
