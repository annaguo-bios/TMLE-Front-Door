# sample size
n.vec <- c(500,1000,2000,4000,8000,50000,100000)
...
dgp.f.name="6-dgp-binaryM-continuousZ-small-var.R" # name for the DGP function
truth = "6-truth-binaryM-continuousZ-uniform100-pz.Rdata" # name for the truth.Rdata
